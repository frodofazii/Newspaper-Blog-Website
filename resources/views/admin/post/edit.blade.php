...
<div class="content-wrapper">
  ...
  <div class="box box-primary">
    ...
    <form role="form" action="{{ route('post.update',$post->id)}}" method="post" enctype="multipart/form-data">
      ...
      <div class="col-lg-6">
        ...
        <div class="form-group" style="margin-top:18px">
          ...
          <select class="form-control select2 select2-hidden-accessible" multiple="" data-placeholder="Select a Category" style="width: 100%;" tabindex="-1" aria-hidden="true" name="tags">
            @foreach($tags as $tag)
    ...
    <div class="box-body pad">
      ...
      <textarea 
      style="width: 100%; height: 500px; font-size: 14px; line-height: 18px;  border: 1px solid #dddddd; padding: 10px;" name="body" id="editor1">{{ $post->body}}</textarea>
